        ...
        <MDBContainer className='text-center text-md-start mt-5'>
          <MDBRow className='mt-3'>
            <MDBCol md="3" lg="4" xl="3" className='mx-auto mb-4'>
              ...
              This website provides user a  platform where they can check the blood availability in different areas and save time.
               People here can also book appointment for donating blood
              </p>
            </MDBCol>
